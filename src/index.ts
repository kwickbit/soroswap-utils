(async () => {
    ...
    const sourceKeypair = Keypair.fromSecret(process.env.MY_TESTNET_PRIVATE_KEY!);
    ...
    const contractAddress = process.env.SOROSWAP_FACTORY_CONTRACT!;
    ...
    let builtTransaction = new TransactionBuilder(sourceAccount, {
        ...
        // The invocation of the `all_pairs_length` function of our contract is added
        // to the transaction. Note: `all_pairs_length` doesn't require any parameters,
        // but many contract functions do. You would need to provide those here.
        .addOperation(contract.call("all_pairs_length"))
    ...
    try {
        ...
        if (sendResponse.status === "PENDING") {
            ...
            if (getResponse.status === "SUCCESS") {
                ...
                console.log(`Transaction meta: ${transactionMeta.value()}`);
